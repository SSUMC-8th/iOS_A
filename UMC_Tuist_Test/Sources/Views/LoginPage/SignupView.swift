    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                Button(action: {
                    KeychainWrapper.save(key: "userID", value: newUser.signupModel.email)
                    KeychainWrapper.save(key: "userPassword", value: newUser.signupModel.password)
                    KeychainWrapper.save(key: "userNickname", value: newUser.signupModel.nickname)
