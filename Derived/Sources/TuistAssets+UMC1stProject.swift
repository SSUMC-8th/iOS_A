...
public enum UMC1stProjectAsset: Sendable {
  ...
  public static let accentColor = UMC1stProjectColors(name: "AccentColor")
    ...
    public static let 고객의소리 = UMC1stProjectImages(name: "고객의 소리")
    public static let 나만의메뉴 = UMC1stProjectImages(name: "나만의 메뉴")
    public static let 로그아웃 = UMC1stProjectImages(name: "로그아웃")
    public static let 마이스타벅스리뷰 = UMC1stProjectImages(name: "마이 스타벅스 리뷰")
    public static let 매장정보 = UMC1stProjectImages(name: "매장 정보")
    public static let 반납기정보 = UMC1stProjectImages(name: "반납기 정보")
    public static let 별히스토리 = UMC1stProjectImages(name: "별 히스토리")
    public static let 스타벅스카드등록 = UMC1stProjectImages(name: "스타벅스 카드 등록")
    public static let 스토어케어 = UMC1stProjectImages(name: "스토어 케어")
    public static let 전자영수증 = UMC1stProjectImages(name: "전자영수증")
    public static let 카드교환권등록 = UMC1stProjectImages(name: "카드 교환권 등록")
    public static let 쿠폰등록 = UMC1stProjectImages(name: "쿠폰 등록")
    public static let 쿠폰히스토리 = UMC1stProjectImages(name: "쿠폰 히스토리")
  }
  public enum Colors {
