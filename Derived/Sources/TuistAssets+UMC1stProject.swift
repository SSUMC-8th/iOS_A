...
public enum UMC1stProjectAsset: Sendable {
  ...
  public static let accentColor = UMC1stProjectColors(name: "AccentColor")
    ...
    public static let bestItems2 = UMC1stProjectImages(name: "bestItems_2")
    public static let bestItems3 = UMC1stProjectImages(name: "bestItems_3")
    public static let bestItems4 = UMC1stProjectImages(name: "bestItems_4")
    public static let bestItems5 = UMC1stProjectImages(name: "bestItems_5")
    public static let bestItems6 = UMC1stProjectImages(name: "bestItems_6")
    public static let bestItems7 = UMC1stProjectImages(name: "bestItems_7")
    public static let bestItems8 = UMC1stProjectImages(name: "bestItems_8")
    ...
    public static let newProducts1 = UMC1stProjectImages(name: "newProducts_1")
    public static let newProducts2 = UMC1stProjectImages(name: "newProducts_2")
    public static let newProducts3 = UMC1stProjectImages(name: "newProducts_3")
    public static let newProducts4 = UMC1stProjectImages(name: "newProducts_4")
    public static let onlinestorebanner = UMC1stProjectImages(name: "onlinestorebanner")
    public static let receiptbutton = UMC1stProjectImages(name: "receiptbutton")
    ...
    public static let 내용보기버튼 = UMC1stProjectImages(name: "내용 보기 버튼")
    public static let 너티크루아상 = UMC1stProjectImages(name: "너티 크루아상")
    ...
    public static let 매콤소시지불고기 = UMC1stProjectImages(name: "매콤 소시지 불고기")
    public static let 미니리프파이 = UMC1stProjectImages(name: "미니 리프 파이")
    ...
    public static let 뺑오쇼콜라 = UMC1stProjectImages(name: "뺑 오 쇼콜라")
    public static let 소시지올리브파이 = UMC1stProjectImages(name: "소시지&올리브 파이")
    ...
    public static let 아이스카라멜마키아또 = UMC1stProjectImages(name: "아이스 카라멜 마키아또")
    public static let 아이스카페아메리카노 = UMC1stProjectImages(name: "아이스 카페 아메리카노")
    public static let 에스프레소마키아또 = UMC1stProjectImages(name: "에스프레소 마키아또")
    public static let 에스프레소콘파나 = UMC1stProjectImages(name: "에스프레소 콘파나")
    ...
    public static let 카라멜마키아또 = UMC1stProjectImages(name: "카라멜 마키아또")
    public static let 카페아메리카노 = UMC1stProjectImages(name: "카페 아메리카노")
