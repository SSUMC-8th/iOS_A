...
public enum UMC1stProjectAsset: Sendable {
  ...
  public static let accentColor = UMC1stProjectColors(name: "AccentColor")
    ...
    public static let listicon = UMC1stProjectImages(name: "listicon")
    public static let mapicon = UMC1stProjectImages(name: "mapicon")
    ...
    public static let 라벤터카페브레베 = UMC1stProjectImages(name: "라벤터 카페 브레베")
    public static let 럼샷코르타도 = UMC1stProjectImages(name: "럼 샷 코르타도")
    ...
    public static let 병음료 = UMC1stProjectImages(name: "병음료")
    ...
    public static let 아이스카푸치노 = UMC1stProjectImages(name: "아이스 카푸치노")
    public static let 아포가토 = UMC1stProjectImages(name: "아포가토")
    ...
    public static let 카푸치노 = UMC1stProjectImages(name: "카푸치노")
    ...
    public static let 홀케이크예약 = UMC1stProjectImages(name: "홀케이크 예약")
  }
  public enum Colors {
